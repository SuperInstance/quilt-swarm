...
await describe('SecretManager', async () => {
  ...
  await it('creates a new secret on first upsert', async () => {
  ...
  await it('updates an existing secret on subsequent upserts without changing id', async () => {
